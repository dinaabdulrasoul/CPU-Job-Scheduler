...
"font: 12pt \"Montserrat\"; font-weight: bold; color: black;")
        ...
        self.plainTextEdit.setGeometry(QtCore.QRect(340, 160, 101, 51))
        self.plainTextEdit.setStyleSheet("border: 2px  solid black;  font: 55 20pt")
        self.plainTextEdit.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.plainTextEdit.setPlainText("")
        self.plainTextEdit.setObjectName("plainTextEdit")
        self.plainTextEdit_4 = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.plainTextEdit_4.setGeometry(QtCore.QRect(90, 310, 291, 371))
        ...
        self.label_4.setGeometry(QtCore.QRect(480, 260, 411, 51))
        self.label_4.setAutoFillBackground(False)
        self.label_4.setStyleSheet("font: 12pt \"Montserrat\"; color: black; font-weight: bold;")
        self.label_4.setObjectName("label_4")
        self.plainTextEdit_3 = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.plainTextEdit_3.setGeometry(QtCore.QRect(480, 310, 301, 371))
        ...
        self.toolButton_6.setGeometry(QtCore.QRect(320, 700, 281, 91))
