...
class SJF(object):
    ...
    def fig_init(self, processes_name, total_burst):
        ...
        self.ax.set_yticklabels(processes_name)
        #self.ax.grid(True)
        self.ax.grid(axis='x')
    ...
    def draw(self, name, start_time, end_time):
        ...
        self.ax.broken_barh([(start_time, end_time - start_time)], (0,5), facecolors=(colors))
        ...
        handles = [] 
        #for i in range(0,len(self.processes_name)):
        #    handles.append(mpatches.Patch(color= colors[i], label='P'+ str(i)))

        self.ax.legend(handles=handles, ncol=len(self.processes_name))
